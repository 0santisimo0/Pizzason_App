...
/**
 * This class will be used to manage the 450 gr portion size for the extra products implements the interface
 * ExtraDessertSizable to apply Open Closed principle.
 *
 * @see ExtrasSizable
 */
public class Portion450gr implements ExtrasSizable {

    /**
     * This method implement of interface ExtraDessertSizable will be used to manage the 450 gr portion size price for the extra
