 ...
 * create a method of pay in this case PayPal method.
 *
 *
 * @see Payment
...
public class PayPayPal extends Payment implements PaymentManagable{
     ...
     */
    public PayPayPal(String namePaymentMethod) {
